    ...
    return function(e) {
        ...
        var o = function() {
            ...
            d = function(e) {
                function t(e) {
                    ...
                    return o.audioContext = null, o.offlineAudioContext = null, o.stateBehaviors = (r = {}, n(r, c, {
                        init: function() {
                ...
                return s(t, e), o(t, [{
                    ...
                    value: function(e, t) {
                        if (this.buffer) {
                            ...
                            e = r.start, t = r.end, this.scheduledPause = t, this.source.start(0, e, t - e), "suspended" == this.ac.state && this.ac.resume && this.ac.resume(), this.setState(c), this.fireEvent("play")
                        }
                    }
                }, {
                    key: "pause",
            ...
            k = (function() {
                ...
                function t(e) {
                    ...
                    if (n.defaultParams = {
                            ...
                            WebAudio: d.default
                        }, n.util = l, n.params = l.extend({}, n.defaultParams, e), n.container = "string" == typeof e.container ? document.querySelector(n.params.container) : n.params.container, !n.container) throw new Error("Container element not found");
                    ...
                    var i = 0;
                    return n._onResize = l.debounce(function() {
                ...
                return i(t, e), o(t, null, [{
                    ...
                    value: function() {
                        var e = Math.round(this.getDuration() * this.params.minPxPerSec * this.params.pixelRatio),
                            ...
                            a = Math.max(n + t, r);
                        this.params.fillParent && (!this.params.scrollParent || e < t) && (r = t, n = 0, a = r);
                        var i = void 0;
                        if (this.params.partialRender) {
                            var s = this.peakCache.addRangeToPeakCache(r, n, a),
                                o = void 0;
                            for (o = 0; o < s.length; o++) i = this.backend.getPeaks(r, s[o][0], s[o][1]), this.drawer.drawPeaks(i, r, s[o][0], s[o][1])
                        } else i = this.backend.getPeaks(r, n, a), this.drawer.drawPeaks(i, r, n, a);
                        this.fireEvent("redraw", i, r)
                    }
                }, {
                    key: "zoom",
                    value: function(e) {
                    ...
                    value: function(e, t, r) {
                        ...
                        if (!t) return a();
                        this.backend.setPeaks(t, r), this.drawBuffer(), this.tmpEvents.push(this.once("interaction", a))
                    }
                }, {
                    ...
                    value: function(e, t, r, n) {
                        var a = this,
                            i = e;
                        if ("string" == typeof e) this.backend.load(i, this.mediaContainer, t, r);
                        else {
                            var s = e;
                    ...
                    value: function(e, t, r, n) {
                        ...
                        var a = this.backend.getPeaks(e, n),
        ...
        function n(e) {
            var t = new i.default,
                ...
                n = !1;
            return r.open(e.method || "GET", e.url, !0), r.responseType = e.responseType || "json", e.xhr && (e.xhr.requestHeaders && e.xhr.requestHeaders.forEach(function(e) {
        ...
        e.exports = function(e, t, r) {
            function n() {
                var l = Date.now() - o;
                l < t && l >= 0 ? a = setTimeout(n, t - l) : (a = null, r || (u = e.apply(s, i), s = i = null))
            }
            var a, i, s, o, u;
            null == t && (t = 100);
            var l = function() {
                ...
                var l = r && !a;
                return a || (a = setTimeout(n, t)), l && (u = e.apply(s, i), s = i = null), u
            };
        ...
        var s = function() {
            ...
            h = function(e) {
                function t(e, r) {
                    n(this, t);
                    var i = a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, r));
                    return i.maxCanvasWidth = r.maxCanvasWidth, i.maxCanvasElementWidth = Math.round(r.maxCanvasWidth / r.pixelRatio), i.hasProgressCanvas = r.waveColor != r.progressColor, i.halfPixel = .5 / r.pixelRatio, i.canvases = [], i.progressWave = null, i
                }
                return i(t, e), s(t, [{
                    key: "init",
                    value: function() {
                    ...
                    value: function(e, t, r) {
                        ...
                        e.start = e.waveCtx.canvas.offsetLeft / a || 0, e.end = e.start + n / a, e.waveCtx.canvas.width = t, e.waveCtx.canvas.height = r, this.style(e.waveCtx.canvas, {
                            width: n + "px"
                        }), this.style(this.progressWave, {
                            display: "block"
                            ...
                            if (void 0 !== r) {
                                ...
                                for (m = v; m < y; m += d) {
                                    var k = u[Math.floor(m * p * l)] || 0,
                                        g = Math.round(k / t * o);
                                    a.fillRect(m + a.halfPixel, o - g + s, h + a.halfPixel, 2 * g)
                                }
                            }
                        })
                    }
                        ...
                        if (t) {
                            ...
                            if (!(c > o || h < s)) {
                                var f = Math.min(c, s),
                                    ...
                                    p = void 0,
                                    v = void 0;
                                for (t.beginPath(), t.moveTo((f - c) * l + this.halfPixel, a + i), p = f; p < d; p++) {
                                    var y = r[2 * p] || 0,
                                        m = Math.round(y / n * a);
                                    t.lineTo((p - c) * l + this.halfPixel, a - m + i)
                                }
                                for (v = d - 1; v >= f; v--) {
                                    var k = r[2 * v + 1] || 0,
                                        g = Math.round(k / n * a);
                                    t.lineTo((v - c) * l + this.halfPixel, a - g + i)
                                }
                                t.closePath(), t.fill()
                            }
                        }
                    ...
                    value: function(e, t, r, n, a) {
                        ...
                        return c.frame(function() {
                            if (e[0] instanceof Array) {
                                var s = e;
                                if (i.params.splitChannels) return i.setHeight(s.length * i.params.height * i.params.pixelRatio), s.forEach(function(e, t) {
                                    return i.prepareDraw(e, t, r, n, a)
                                });
                                e = s[0]
                            }
                            var o = 1 / i.params.barHeight;
                            if (i.params.normalize) {
                                var u = c.max(e),
                                    l = c.min(e);
                                o = -l > u ? -l : u
                            }
                            var h = [].some.call(e, function(e) {
                                ...
                                f = i.params.height * i.params.pixelRatio;
                            return a({
                                absmax: o,
                                hasMinVals: h,
                                height: f,
        ...
        var s = function() {
            ...
            l = function(e) {
                function t(e, r) {
                    ...
                    return i.container = e, i.params = r, i.width = 0, i.height = r.height * i.params.pixelRatio, i.lastPos = 0, i.wrapper = null, i
                }
                return i(t, e), s(t, [{
                    key: "style",
                    value: function(e, t) {
                    ...
                    value: function(e, t) {
                        ...
                        var r = e.targetTouches ? e.targetTouches[0].clientX : e.clientX,
                            ...
                            i = this.getWidth(),
                            s = void 0;
                        return !this.params.fillParent && a < i ? (s = (r - n.left) * this.params.pixelRatio / a || 0) > 1 && (s = 1) : s = (r - n.left + this.wrapper.scrollLeft) / this.wrapper.scrollWidth || 0, s
                    }
                }, {
            ...
            h = (function(e) {
                ...
                return i(t, e), s(t, [{
                    ...
                    value: function(e, t, r, n) {
                        ...
                        a.controls = this.params.mediaControls, a.autoplay = this.params.autoplay || !1, a.preload = null == n ? "auto" : n, a.src = e, a.style.width = "100%";
                        var i = t.querySelector(this.mediaType);
                        i && t.removeChild(i), t.appendChild(a), this._load(a, r)
                    }
                }, {
                    key: "loadElt",
                    value: function(e, t) {
            ...
            i = function() {
                ...
                return a(e, [{
                    ...
                    value: function(e, t, r) {
                        ...
                        for (var n = [], a = 0; a < this.peakCacheRanges.length && this.peakCacheRanges[a] < t;) a++;
                        for (a % 2 == 0 && n.push(t); a < this.peakCacheRanges.length && this.peakCacheRanges[a] <= r;) n.push(this.peakCacheRanges[a]), a++;
                        ...
                        var i = [];
                        for (a = 0; a < n.length; a += 2) i.push([n[a], n[a + 1]]);
                        return i
                    }
                }, {
                    key: "getCacheRanges",
